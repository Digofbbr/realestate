...
const PropertyDetails = ({propertyDetails: {price, rentFrequency, description, rooms, baths, title, area, agency, isVerified, type, purpose, furnishingStatus, amenities, photos }}) => (
